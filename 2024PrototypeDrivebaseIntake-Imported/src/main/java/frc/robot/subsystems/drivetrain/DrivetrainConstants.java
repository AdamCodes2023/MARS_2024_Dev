...
public final class DrivetrainConstants {
  ...
  public static final double FRONT_LEFT_MODULE_STEER_OFFSET =
      230.01; // FIXME Measure and set front left steer offset
  ...
  public static final double FRONT_RIGHT_MODULE_STEER_OFFSET =
      278.26; // FIXME Measure and set front right steer offset

  public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 16; // Set back left drive motor ID
  public static final int BACK_LEFT_MODULE_STEER_MOTOR = 17; // Set back left steer motor ID
  ...
  public static final double BACK_LEFT_MODULE_STEER_OFFSET =
      185.098; // FIXME Measure and set back left steer offset

  public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 14; // Set back right drive motor ID
  public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 15; // Set back right steer motor ID
  ...
  public static final double BACK_RIGHT_MODULE_STEER_OFFSET =
      285.029; // FIXME Measure and set back right steer offset
   ...
   */
  public static final double TRACKWIDTH_METERS = 0.5969; // unknown inches
   ...
   * <p>Should be measured from center to center.
   */
  public static final double WHEELBASE_METERS = 0.5334; // unknown inches
  ...
  */
  ...
  public static final String VISION_TAPE_CAMERA_NAME = "OV5647";
}
