...
public class GripperWristConstants {
  /**** GRIPPER CONSTANTS ****/
  public static final int gripperWristMotorID = 33;

  public static final int forwardGripperWristSwitchNumber = 7;
  // public static final int reverseGripperWristSwitchNumber = 4;
  // public static final int toPosGripperWristButtonNumber = 7;
  // public static final int zThrottleGripperWristButtonNumber = 2;
  /**** GRIPPER CONSTANTS ****/
