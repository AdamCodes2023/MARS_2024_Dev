...
public class DualJoysticksOI implements OperatorInterface {
  ...
  @Override
  public Trigger getCenterOnChargingPadButton() {
  ...
  // @Override
  // public Trigger getCenterOnLowNodeButton() {
  // return translateJoystickButtons[8];
  // }

  @Override
  public Trigger getCenterOnMidNodeButton() {
    return translateJoystickButtons[6];
  }

  @Override
  public Trigger getCenterOnHighNodeButton() {
    return translateJoystickButtons[7];
  }

  // @Override
  // public Trigger getCenterOnConeButton() {
  // return translateJoystickButtons[6];
  // }

  // @Override
  // public Trigger getCenterOnCubeButton() {
  // return translateJoystickButtons[7];
  // }

  @Override
  public Trigger getCenterOnObjectButton() {
    return translateJoystickButtons[2];
  }

  @Override
  public Trigger getCenterOnAprilTagButton() {
