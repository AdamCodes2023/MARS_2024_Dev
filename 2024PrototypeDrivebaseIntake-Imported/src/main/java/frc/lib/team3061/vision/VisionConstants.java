...
public final class VisionConstants {
  ...
  public static final String CONE_CUBE_CAMERA_NAME = "JetsonTable";
  ...
  public static final double MACHINE_VISION_OFFSET =
      50.0; // FIXME: ADD OFFSET FOR MACHINE VISION CAMERA
}
