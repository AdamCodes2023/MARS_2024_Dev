...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    */
    ...
    //oi.getPositiveAngleButton().onTrue(Commands.runOnce(() -> shooterAngle.setMotorSpeed(0.5), shooterAngle));
    oi.getPositiveAngleButton().onTrue(Commands.runOnce(() -> shooterAngle.smartMotionPosition(200), shooterAngle));
    oi.getPositiveAngleButton().onFalse(Commands.runOnce(() -> shooterAngle.stopMotor(), shooterAngle));
    // run negative shooter angle
    //oi.getNegativeAngleButton().onTrue(Commands.runOnce(() -> shooterAngle.setMotorSpeed(-0.5), shooterAngle));
    oi.getNegativeAngleButton().onTrue(Commands.runOnce(() -> shooterAngle.smartMotionPosition(-200), shooterAngle));
    oi.getNegativeAngleButton().onFalse(Commands.runOnce(() -> shooterAngle.stopMotor(), shooterAngle));
  }
