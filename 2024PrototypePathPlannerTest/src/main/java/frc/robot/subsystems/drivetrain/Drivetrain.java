...
public class Drivetrain extends SubsystemBase {
  ...
  */
  ...
  public void resetPose(Pose2d currentPose) {
    poseEstimator.resetPosition(this.getRotation(), swerveModulePositions, currentPose);
  }
  ...
  */
  ...
  public ChassisSpeeds getRobotRelativeSpeeds() {
    ChassisSpeeds robotChassisSpeeds = null;
    robotChassisSpeeds = new ChassisSpeeds(getVelocityX(), getVelocityY(), getVelocityRotational());
  ...
  public void driveRobotRelative(ChassisSpeeds robotRelativeSpeeds) {
    ...
    switch (driveMode) {
      case NORMAL:
          chassisSpeeds = new ChassisSpeeds(robotRelativeSpeeds.vxMetersPerSecond, robotRelativeSpeeds.vyMetersPerSecond, robotRelativeSpeeds.omegaRadiansPerSecond);
  ...
  public void centerOnAprilTag(DoubleSupplier xVel, DoubleSupplier yVel) {
    drive(xVel.getAsDouble(), yVel.getAsDouble(), vision.aprilTagLock());
  }
