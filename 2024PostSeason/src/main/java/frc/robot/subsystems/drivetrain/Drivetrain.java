...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain(
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in
            ...
            new PIDConstants(5.0, 0.0, 0.01), // Translation PID constants
  ...
  */
  ...
  public void centerOnAprilTag() {
    drive(0.0, 0.0, vision.aprilTagLock());
  }

  public boolean atAprilTagAlignment() {
    return vision.atAlignment();
  }
  ...
  public boolean atYTranslation(double yPos, double originalY, boolean reset) {
    if (yPos < originalY) {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("PoseY", poseEstimatorPose.getY());
  }
