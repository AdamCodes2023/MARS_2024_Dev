...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    leftShooter.config_IntegralZone(
        ShooterConstants.kPIDLoopIdx, ShooterConstants.kGains.kIzone, ShooterConstants.kTimeoutMs);
  ...
  public void runShooter(double speed) {
    leftShooter.set(ControlMode.Velocity, (-speed * speedCorrector));
    rightShooter.set(ControlMode.Velocity, (speed * speedCorrector));
  }
